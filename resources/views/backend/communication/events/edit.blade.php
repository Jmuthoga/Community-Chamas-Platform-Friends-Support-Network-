...
<div class="card shadow-sm border-0">
    <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
        <h3 class="card-title mb-0">
            <i class="fas fa-calendar-alt me-2"></i> Edit Event
        </h3>
    ...
    <div class="card-body">
        <form action="{{ route('backend.admin.communications.events.update', $event->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PUT')

            {{-- Hidden inputs for database --}}
            <input type="hidden" name="send_email" id="input_send_email" value="{{ $event->send_email }}">
            <input type="hidden" name="send_sms" id="input_send_sms" value="{{ $event->send_sms }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input" id="notify_none" {{ !$event->send_email && !$event->send_sms ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input notify-switch" id="notify_email" {{ $event->send_email ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input notify-switch" id="notify_sms" {{ $event->send_sms ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input" id="notify_both" {{ $event->send_email && $event->send_sms ? 'checked' : '' }}>
