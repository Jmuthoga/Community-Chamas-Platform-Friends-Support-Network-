...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        <form action="{{ route('backend.admin.communications.announcements.update', $announcement->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PUT')

            {{-- Hidden inputs for database --}}
            <input type="hidden" name="send_email" id="input_send_email" value="{{ old('send_email', $announcement->send_email) }}">
            <input type="hidden" name="send_sms" id="input_send_sms" value="{{ old('send_sms', $announcement->send_sms) }}">
            ...
            <div class="mb-4">
                ...
                <textarea id="body" name="body" class="form-control form-control-lg" rows="6" required>{{ old('body', $announcement->message) }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input" id="notify_none" {{ (!old('send_email', $announcement->send_email) && !old('send_sms', $announcement->send_sms)) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input notify-switch" id="notify_email" {{ old('send_email', $announcement->send_email) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input notify-switch" id="notify_sms" {{ old('send_sms', $announcement->send_sms) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input" id="notify_both" {{ (old('send_email', $announcement->send_email) && old('send_sms', $announcement->send_sms)) ? 'checked' : '' }}>
