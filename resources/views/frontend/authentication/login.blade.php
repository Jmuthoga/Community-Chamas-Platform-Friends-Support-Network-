...
<head>
    ...
    <style>
        ...
        .google-btn {
            background-color: var(--fsn-green);
            color: #ffffff;
        }

        .google-btn:hover {
            background-color: var(--fsn-green-light);
            color: #ffffff;
        }
...
<div style="display: flex; justify-content: center; align-items: center;">
    <a href="{{ route('frontend.home') }}" class="logo">
        <img src="{{ assetImage(readconfig('site_logo')) }}" width="200px" alt="brand-logo">
                    ...
                    <p class="form-des">Welcome back! Sign in to access your account at {{ readConfig('site_name') }}</p>
                </div>
