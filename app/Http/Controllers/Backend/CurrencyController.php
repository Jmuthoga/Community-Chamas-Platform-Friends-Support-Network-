...
class CurrencyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        abort_if(!auth()->user()->can('currency-view'), 403);
        if ($request->ajax()) {
...
<button type="submit" class="dropdown-item" onclick="return confirm(\'Are you sure ?\')"><i class="fas fa-trash"></i> Delete</button>
    ...
    public function create()
    {
        ...
        abort_if(!auth()->user()->can('currency-create'), 403);
    ...
    public function edit($id)
    {
        ...
        abort_if(!auth()->user()->can('currency-update'), 403);
    ...
    public function destroy($id)
    {
        ...
        abort_if(!auth()->user()->can('currency-delete'), 403);
        $currency = Currency::findOrFail($id);
        $currency->delete();
